$(function() {
	...
	$(document).ready(function(){
		/*
		$(".p_cfjd_bt_0").click(function(){
			if(!$(".panel").is(":animated")){
				$(".p_cfjd_dt_0").slideToggle("slow");
			}
		});

		$(".p_cfjd_bt_1").click(function(){
			if(!$(".panel").is(":animated")){
				$(".p_cfjd_dt_1").slideToggle("slow");
			}
		});

		$(".p_cfjd_bt_2").click(function(){
			if(!$(".panel").is(":animated")){
				$(".p_cfjd_dt_2").slideToggle("slow");
			}
		});

		$(".p_cfjd_bt_3").click(function(){
			$(".p_cfjd_dt_3").slideToggle("slow");
		});

		$(".p_cfjd_bt_4").click(function(){
			$(".p_cfjd_dt_4").slideToggle("slow");
		});

		$(".p_cfjd_bt_5").click(function(){
			$(".p_cfjd_dt_5").slideToggle("slow");
		});

		$(".aside_txcp").click(function(){
			$(".aside_txcp_sub").slideToggle("slow");
		});

		$(".aside_cfjd").click(function(){
			$(".aside_cfjd_sub").slideToggle("slow");
		});
		*/
		$(".p_bt").click(function(){
			$(this).parent().parent().find('.p_dt').slideToggle("slow", function(){
				if ($(this).parent().parent().find('.p_dt').is(':hidden')) {
					$(this).parent().parent().find('.p_bt').text("了解更多");
				}
				else
				{
					$(this).parent().parent().find('.p_bt').text("了解完毕");
				}
			});
		});

		$(".aside_lvl_0").click(function(){
			$(this).parent().find('.aside_lvl_1').slideToggle("slow", function(){
				if ($(this).parent().find('.aside_lvl_1').is(':hidden')) {
					$(this).parent().find('img').attr("src","img/aside/select_xl01.png");
				}
				else
				{
					$(this).parent().find('img').attr("src","img/aside/select_xl.png");
				}
			});
		});
